...
if (isset($_POST['create'])) {
    ...
    $ACTIVITY->title = filter_input(INPUT_POST, 'title');
    $ACTIVITY->short_description = filter_input(INPUT_POST, 'short_description');
    $ACTIVITY->description = filter_input(INPUT_POST, 'description');
