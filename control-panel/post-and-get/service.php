...
if (isset($_POST['create'])) {
    ...
    $SERVICE->title = filter_input(INPUT_POST, 'title');
    $SERVICE->short_description = filter_input(INPUT_POST, 'short_description');
    $SERVICE->description = filter_input(INPUT_POST, 'description');
