...
<html lang="en" dir="ltr">
    ...
    <head>
        ...
        <title>Dive Sites || Pearl Divers Sri Lanka</title>
            ...
            <section class="page-header">
                ...
                <div class="container">
                    <ul class="list-unstyled thm-breadcrumb">
                        <li><a href="">Home</a></li>
                        <li class="active"><a href="#">Dive Sites</a></li>
                    </ul><!-- /.list-unstyled -->
                    <h2 class="page-header__title">Dive Sites</h2><!-- /.page-header__title -->
                </div><!-- /.container -->
            </section><!-- /.page-header -->
            ...
            <section class="course-details">
                <div class="container">
                    <div class="course-details__image">
                        <img src="assets/images/divesite/divesites-unawatuna.jpg" alt="">
